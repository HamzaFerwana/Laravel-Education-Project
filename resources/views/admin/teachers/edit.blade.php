...
@section('content')
    ...
    <form action="{{ route('admin.teachers.update', $teacher->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-2">
            ...
            <input type="text" name="name" id="name" placeholder="Name" value="{{ old('name', $teacher->name) }}"
        ...
        <div class="mb-2">
            ...
            <input type="text" name="tw_link" id="tw_link" placeholder="Twitter Link" value="{{ old('tw_link', $teacher->tw_link) }}"
        ...
        <div class="mb-2">
            ...
            <input type="text" name="insta_link" id="insta_link" placeholder="Instagram Link"
                value="{{ old('insta_link', $teacher->insta_link) }}"
        ...
        <div class="mb-3">
            ...
            is-invalid
            @enderror">{{ old('about', $teacher->about) }}</textarea>
            @error('about')
                <small class="invalid-feedback">{{ $message }}</small>
            @enderror
        </div>
